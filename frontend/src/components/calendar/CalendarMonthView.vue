...
function getTaskColor(task: Task) {
  ...
  if (task.priority === 'LOW')
    return 'bg-green-500/30 border-green-500 text-green-700 dark:text-green-300'
      ...
      <div class="w-full h-full overflow-x-auto overflow-y-hidden custom-scrollbar">
        ...
        <div class="grid grid-cols-7 grid-rows-[auto_repeat(6,minmax(0,1fr))] h-full min-w-[800px]">
          ...
          <div
            ...
            :class="[
              day.isCurrentMonth
                ...
                : 'bg-muted/10 opacity-70 hover:bg-muted/20',
          ...
          >
            ...
            <div
              class="flex flex-col gap-1 overflow-y-auto min-h-0 flex-1 px-1.5 pb-2 custom-scrollbar"
            >
              <div
              ...
              >
                <div class="flex items-center justify-between gap-1 w-full min-w-0">
                  ...
                  <span class="text-[9px] font-black opacity-60 shrink-0">{{
