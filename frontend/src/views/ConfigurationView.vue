  ...
  <div class="w-full max-w-7xl mx-auto space-y-8">
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
      <div>
        ...
        <h1 class="text-5xl font-black tracking-tight mt-2">
          Configuración
        </h1>
      </div>
        ...
        <CardContent class="space-y-5 px-5">
          <div class="flex flex-col items-center">
            <div class="relative rounded-3xl overflow-hidden border-4 border-primary/20 shadow-xl">
              <img :src="avatarPreviewUrl" alt="Avatar" class="w-38 h-38 object-cover bg-background" />
              <Button size="icon" class="absolute bottom-3 right-3 rounded-full shadow-lg" @click="randomSeed">
