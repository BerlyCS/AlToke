          ...
          <div class="space-y-4">
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p v-if="user.role == 'BANNED'" class="font-bold line-through">
                    {{ user.nickname }}
                  </p>
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    class="h-8 w-8 p-0 text-purple-500"
...
import { Search, Filter, Eye, Trash2, Users, CircleOff, UserRoundCheck } from 'lucide-vue-next'
