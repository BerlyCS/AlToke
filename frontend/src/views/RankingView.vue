...
<template>
  <div class="h-full flex flex-col p-4 md:p-8 overflow-y-auto w-full max-w-7xl mx-auto space-y-10 pb-20">
    ...
    <div class="mt-8 space-y-8">
      ...
      <!-- Podium Layout -->
      <div v-else-if="leaderboard.length >= 1" class="grid grid-cols-1 md:grid-cols-3 gap-6 items-end mt-16 md:mt-28 max-w-4xl mx-auto">
        <!-- 2nd Place -->
        <div v-if="secondPlace" @click="openProfile(secondPlace)" class="cursor-pointer">
          <Card class="relative text-center shadow-md bg-gradient-to-t from-gray-50 to-card dark:from-gray-900/20 transform md:-translate-y-8 mt-6 md:mt-0 hover:shadow-xl hover:scale-[1.02] transition-all">
        ...
        <div v-if="firstPlace" @click="openProfile(firstPlace)" class="cursor-pointer">
          <Card class="relative text-center shadow-xl border-yellow-200 dark:border-yellow-900/50 bg-gradient-to-t from-yellow-50 to-card dark:from-yellow-950/20 transform md:-translate-y-16 mt-6 md:mt-0 hover:shadow-2xl hover:scale-[1.02] transition-all">
        ...
        <div v-if="thirdPlace" @click="openProfile(thirdPlace)" class="cursor-pointer">
          <Card class="relative text-center shadow-sm bg-gradient-to-t from-orange-50 to-card dark:from-orange-950/10 mt-6 md:mt-0 hover:shadow-lg hover:scale-[1.02] transition-all">
            <CardContent class="pt-8 pb-6 px-4 flex flex-col items-center">
              <div class="relative mb-4">
                ...
                <div class="absolute -top-2 -right-2 w-8 h-8 bg-orange-300 dark:border-orange-700 text-orange-950 dark:text-orange-50 font-black flex items-center justify-center rounded-full text-base shadow-lg border-2 border-white dark:border-gray-800 z-10">3</div>
              </div>
          ...
          <div class="overflow-x-auto table-container overflow-y-auto">
            <table class="w-full text-left border-collapse">
              ...
              <tbody class="divide-y divide-border">
                ...
                >
                  <td class="px-6 py-4 text-center font-black text-muted-foreground group-hover:text-foreground transition-colors">#{{ user.rank }}</td>
                  <td class="px-6 py-4">
